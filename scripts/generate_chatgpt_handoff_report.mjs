...
const nextAction = data?.nextCodexTask ?? "v6.1.2 Mission Control UI and live cleanup is ready for controlled deploy proof after the health endpoint shows v6_1_2_mission_control_ui_live_cleanup. Next recommended phase: apply migration 019 if needed, review Settings cleanup counts, then apply soft-delete cleanup only if safe.";
