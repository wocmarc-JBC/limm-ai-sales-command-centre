...
const nextAction = data?.nextCodexTask ?? "v6.1 UI polish and test-lead cleanup is ready for controlled deploy proof after the health endpoint shows v6_1_1_dashboard_declutter_live_cleanup. Next recommended phase: apply migration 019 if needed, run cleanup dry-run, review the report, then apply soft-delete cleanup only if safe.";
