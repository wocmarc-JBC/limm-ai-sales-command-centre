...
check("publishes the v10.3.0 operator-experience release", () => {
  ...
  assert.ok(packageJson.scripts.verify.includes("test:v10.4.0") || packageJson.scripts.verify.includes("test:v10.5.0") || packageJson.scripts.verify.includes("test:v10.6.0") || packageJson.scripts.verify.includes("test:v11.1.0") || packageJson.scripts.verify.includes("test:v11.1.3"));
  if (packageJson.scripts.verify.includes("test:v11.1.0") || packageJson.scripts.verify.includes("test:v11.1.3")) {
