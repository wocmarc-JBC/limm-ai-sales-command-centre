...
for (const required of [
  ...
  "docs/V6_1_8_DASHBOARD_COMPRESSION_ZERO_STATE_POLISH.md",
...
for (const field of [
  ...
  "mapFitToBoundsAvailable",
  "mapCroppingFixed",
  "areaLabelsBoundedToPolygons",
  "fakeSentosaRemoved",
  ...
  "meetingPrepBrainAvailable",
  "lifestyleIntakeAvailable",
  "householdOccupantsIntakeAvailable",
  "helperPetsIntakeAvailable",
  "safetyAccessibilityIntakeAvailable",
  "budgetExpectationCaptureAvailable",
  "timelineKeyMoveInCaptureAvailable",
  "intakeChecklistAvailable",
  "missingInfoDetectorAvailable",
  "intakeQuestionLimitAvailable",
  "maxFiveQuestionsRuleAvailable",
  "noOverlyTechnicalFirstContactQuestions",
  "budgetExpectationCollectionNoPriceReply",
  "meetingReadinessScoreAvailable",
...
assert(pkg.scripts?.["test:v6.1.8"], "package.json missing v6.1.8 dashboard compression test script.");
