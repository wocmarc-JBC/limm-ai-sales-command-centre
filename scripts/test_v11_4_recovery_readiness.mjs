...
assert.match(workflow, /independent_pg_dump_s3_core_no_managed_schemas/);
assert.match(workflow, /databaseScope:"core_business_data"/);
...
assert.match(workflow, /--section=pre-data/);
assert.match(workflow, /--section=data/);
assert.match(workflow, /--section=post-data/);
