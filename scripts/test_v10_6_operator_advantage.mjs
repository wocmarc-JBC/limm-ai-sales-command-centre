...
check("publishes and chains the v10.6.0 Operator Advantage release", () => {
  ...
  assert.ok(packageJson.scripts.verify.includes("test:v10.6.0") || packageJson.scripts.verify.includes("test:v11.1.0") || packageJson.scripts.verify.includes("test:v11.1.3") || packageJson.scripts.verify.includes("test:v11.2.0"));
