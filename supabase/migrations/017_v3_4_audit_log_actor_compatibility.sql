...
-- v3.4 compatibility note:
-- Older audit_logs schema required `actor`, while v3.1+ app code writes actor_type/actor_name.
-- This migration keeps both styles compatible and preserves audit log immutability policies.
